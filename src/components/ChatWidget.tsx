...
const FAQ_DATA: FAQ[] = [
  {
    ...
    answer: 'Our cards start from **PKR 80/card** for minimalist designs and go up to **PKR 110+/card** for luxury collections. Pricing depends on design complexity, paper quality, and finishing. We offer quantity-based discounts too!',
        ...
        {isOpen && (
          ...
          >
            ...
            <a
              ...
              onClick={() => whatsappClick('chat_widget')}
            >
